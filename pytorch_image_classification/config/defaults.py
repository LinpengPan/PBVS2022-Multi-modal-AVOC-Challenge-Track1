...
config.device = 'cuda'
config.frozen = False  # 是否冻结模型除全连接层以外的层
# cuDNN
...
config.dataset.name = 'SAR10'
# config.dataset.dataset_dir = '/media/disk1/lixiaohan/Dataset/SAR/train_images/SAR_copy'
# config.dataset.dataset_dir_val = '/media/disk1/lixiaohan/Dataset/SAR/SAR_out_rotate'
# config.dataset.dataset_dir = '/media/disk1/lixiaohan/Dataset/cifar/cifar-100-python'
config.dataset.dataset_dir = '/media/disk1/lixiaohan/Dataset/SAR/train_images/EO/'
config.dataset.dataset_dir_val = ''
# config.dataset.dataset_dir_val = '/media/disk1/lixiaohan/Dataset/cifar/cifar-100-python'
config.dataset.image_size = 56
config.dataset.n_channels = 1#original 3
config.dataset.n_classes = 10

config.model = ConfigNode()
# options: 'cifar', 'imagenet'
# Use 'cifar' for small input images
config.model.type = 'sar10'
...
config.train.output_dir = 'experiments/exp01'
...
config.scheduler.milestones = [40, 60]
...
# augmentation loss: mixup, ricap, cutmix, label_smoothing, dual_cutout
config.augmentation.use_filter = True
...
#add new term
# config.test.dataset_dir = '/media/disk1/ligongzhe/Dataset/SAR/test/'
config.test.dataset_dir = '/media/disk1/ligongzhe/Dataset/sar2022/valid/'
config.test.ttaNum = 0
# test data loader
